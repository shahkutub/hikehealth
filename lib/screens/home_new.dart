...
class HomeNew extends StatefulWidget {
  HomeNew({Key key, this.title, this.show_back_button = false, go_back = true})
      : super(key: key);
...
class _HomeState extends State<HomeNew> with TickerProviderStateMixin {
 ...
 // ScrollController _mainScrollController = ScrollController();
  ...
  fetchProductData() async {
    ...
    print("productResponse:"+productResponse.toString());

    _productList.addAll(productResponse.products);
    print("_productList:"+_productList.length.toString());
    _isProductInitial = false;
    _totalProductData = productResponse.meta.total;
    _showProductLoadingContainer = false;
    setState(() {});
